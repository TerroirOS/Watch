...
export default function NewCasePage() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const data: { error?: string; caseId?: string } = await response.json();
  ...
  return (
    <div className="container" style={{ padding: "80px 0" }}>
      <header style={{ marginBottom: "40px" }}>
        ...
        >
          Upload certificates, lab reports, export declarations, or product labels to
          cross-check origin claims against institutional records.
        </p>
      </header>
      ...
      <main>
        ...
        >
          ...
          <div style={{ marginBottom: "24px" }}>
            <label htmlFor="title" style={{ display: "block", fontWeight: 600, marginBottom: "8px" }}>
              Case Title
            </label>
            <input
              id="title"
